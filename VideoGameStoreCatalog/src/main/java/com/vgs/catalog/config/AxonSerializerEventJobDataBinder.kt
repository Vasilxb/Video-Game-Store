...
@Component
class AxonSerializerEventJobDataBinder(
    ...
    override fun toJobData(eventMessage: Any): JobDataMap {
        ...
        val serializedEvent =
            serializer.serialize(eventMessage, String::class.java)
    ...
    override fun fromJobData(jobData: JobDataMap): Any {
        ...
        val type = SimpleSerializedType(
            jobData["type.name"] as String?,
            jobData["type.revision"] as String?
        )

        val serializedEvent = SimpleSerializedObject(
            jobData["data"] as String?,
            String::class.java,
            type
        )
