...
@PactFolder("pacts")
class OrderCatalogProducerTest {
    ...
    @PactVerifyProvider("OrderCreatedEvent when an order is created")
    ...
    @PactVerifyProvider("OrderStatusUpdatedEvent when an order is cancelled")    fun verifyOrderStatusUpdatedEvent(): MessageAndMetadata {
